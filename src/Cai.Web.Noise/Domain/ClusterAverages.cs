...
/// </param>
internal sealed record ClusterTally(string ClusterId, int Judged, int Noise, string? ClaimClass = null);
...
/// </param>
internal sealed record ClusterAverageSummary(
    double? MicroRate,
    double? MacroRate,
...
/// </remarks>
internal static class ClusterAverages
{
