...
/// </param>
internal sealed record CrowdOffer(string FindingId, FindingRecord? Evidence, string? EvidenceProblem);
...
/// </remarks>
internal static class CrowdOffering
{
    /// <summary>The next item for this rater, or null when there is nothing left for them.</summary>
    public static CrowdOffer? Next(CrowdRound round, string raterId, INoiseFindingStore store, DateTimeOffset now)
    {
