...
internal sealed record CrowdCandidate(string FindingId, CascadeState State, string OwnerId);

/// <summary>A queued item, as the QUEUE holds it — reason included.</summary>
internal sealed record CrowdQueueItem(string FindingId, CrowdReason Reason, string OwnerId);
...
/// </remarks>
internal sealed record CrowdItemView(string FindingId);
...
/// </remarks>
internal static class CrowdQueue
{
    /// <summary>
