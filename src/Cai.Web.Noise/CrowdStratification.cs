...
/// </remarks>
internal enum RaterAffiliation
{
...
internal sealed record RaterStratum(string RaterId, string PrimaryLanguage, RaterAffiliation Affiliation);
...
/// </param>
internal sealed record CrowdComposition(
...
/// </remarks>
internal static class CrowdStratification
{
