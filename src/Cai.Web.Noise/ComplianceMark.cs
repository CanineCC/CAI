...
internal sealed record MarkInputs(
...
/// </param>
internal sealed record MarkCondition(string Name, string Reads);

/// <summary>A condition that failed, with why.</summary>
internal sealed record MarkFailure(string Condition, string Why);
...
/// </remarks>
internal static class ComplianceMark
{
