...
/// </param>
internal sealed record PooledFinding(
...
/// </param>
internal sealed record PooledToolResult(
...
internal sealed record PooledRecallSummary(
...
/// </remarks>
internal static class PooledRecall
{
    /// <summary>
