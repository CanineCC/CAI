...
/// </param>
internal sealed record Honeypot(string FindingId, NoiseVerdict Truth, HoneypotSource Source, string? Evidence);
...
/// </param>
internal sealed record RaterScore(string RaterId, int Answered, int Agreed, double? Accuracy)
{
...
/// </summary>
internal static class RaterCalibration
{
    /// <summary>
